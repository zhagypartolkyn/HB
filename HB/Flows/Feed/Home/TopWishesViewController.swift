...
class TopWishesViewController: UIViewController {
    
    // MARK: - Variables
    private var viewModel: TopWishesViewModel
    ...
    // MARK: - LifeCycle
    init(viewModel: TopWishesViewModel, wishDetailViewModel: WishDetailViewModel) {
...
// MARK: - Location
extension TopWishesViewController: UserLocationFinderDelegate {
...
extension TopWishesViewController: WishCellDelegate {
...
// MARK: - Wish Detail
extension TopWishesViewController {
